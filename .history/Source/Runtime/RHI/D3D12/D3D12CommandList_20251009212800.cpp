...
void D3D12CommandList::SetVertexBuffer(uint32_t slot, IRHIBuffer* buffer)
{
	...
	if (vbView.BufferLocation == 0 || vbView.SizeInBytes == 0 || vbView.StrideInBytes == 0)
	{
...
void D3D12CommandList::SetIndexBuffer(IRHIBuffer* buffer)
{
	...
	if (ibView.BufferLocation == 0 || ibView.SizeInBytes == 0 || ibView.Format == DXGI_FORMAT_UNKNOWN)
	{
