...
private:
	LogLevel m_level = LogLevel::LL_INFO;
...
#define LOG_TRACE(format, ...)		LOG(LogLevel::LL_TRACE, format, __VA_ARGS__)
#define LOG_INFO(format, ...)		LOG(LogLevel::LL_INFO, format, __VA_ARGS__)
#define LOG_DEBUG(format, ...)		LOG(LogLevel::LL_DEBUG, format, __VA_ARGS__)
#define LOG_WARN(format, ...)		LOG(LogLevel::LL_WARN, format, __VA_ARGS__)
#define LOG_ERROR(format, ...)		LOG(LogLevel::LL_ERROR, format, __VA_ARGS__)
#define LOG_FATAL(format, ...)		LOG(LogLevel::LL_FATAL, format, __VA_ARGS__)
